...
// Loop over R^2 values (Parallelize this loop)
...
// Run multiple trials (Parallelize this loop)
#pragma omp parallel for
...
#pragma omp critical
                ...
                // Output progress of trials (Note: This print statement should ideally be outside the parallelized loop to avoid cluttered output)
                if (i % 5 == 0)
                {
